...
```
To control the colours used in the bar chart for the graphs generated by report.py, set the colour using a comma after the category display name. The available colour options are here: https://matplotlib.org/stable/gallery/color/named_colors.html
## Filters
